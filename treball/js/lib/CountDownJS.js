...
function CountDownObject() {
	...
	this.Start = function (element) {
		...
		html += '<img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" id="ResizingImage' + this.CANVAS_NAME + '" width="100%" height="1"></img>';
		html += '<canvas id="' + this.CANVAS_NAME + '"></canvas>';
		html += '</div>';
